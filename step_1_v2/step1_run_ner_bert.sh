...
# 创建所有需要的目录（合并重复的目录创建）
mkdir -p /project/hrao/Meta-Resample/log/step_1_v2
...
script_path="/project/hrao/Meta-Resample/step_1_v2/step1_run_ner.py"
output_base_dir="/project/hrao/Meta-Resample/output"
log_dir="/project/hrao/Meta-Resample/log/step_1_v2"
...
# 使用方法: sbatch /project/hrao/Meta-Resample/step_1_v2/step1_run_ner_bert.sh