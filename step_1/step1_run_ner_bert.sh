...
# 创建所有需要的目录（合并重复的目录创建）
mkdir -p /project/hrao/Meta-Resample/log/step_1
...
script_path="/project/hrao/Meta-Resample/step_1/step1_run_ner.py"
output_base_dir="/project/hrao/Meta-Resample/output"
log_dir="/project/hrao/Meta-Resample/log/step_1"

# 硬度感知采样参数
HARDNESS_SAMPLING_ENABLED=False
HARDNESS_BETA=0.9
HARDNESS_ALPHA=1
HARDNESS_EPSILON=1e-6
HARDNESS_INITIAL_LOSS=1.0
HARDNESS_P_MAX_VALUE=0.001
...
# 使用方法: sbatch /project/hrao/Meta-Resample/step_1/step1_run_ner_bert.sh